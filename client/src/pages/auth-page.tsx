...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen py-12 bg-neutral">
      <div className="container mx-auto px-4">
        <div className="bg-white p-8 rounded-lg shadow-sm max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          {/* Left Column - Forms */}
          <div>
          ...
          <div className="hidden md:block">
            <div className="h-full flex flex-col justify-center">
              <h2 className="font-serif text-2xl mb-4">@byaimymmdoh</h2>
              <p className="text-gray-600 mb-6">
                Join our community of fashion enthusiasts and enjoy exclusive benefits:
              </p>
              <ul className="space-y-3 text-gray-600">
                ...
                <li className="flex items-start">
                  <span className="mr-2">✓</span>
                  <span>Special members-only discounts</span>
                </li>
              </ul>
              <div className="mt-8">
                <img 
